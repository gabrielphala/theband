...
module.exports = (router) => {
    ...
    router.get('/artist/discography', base_controller.render('artist/discography', 'My discography'));
    router.get('/artist/invitations', base_controller.render('artist/invitations', 'My invitations'));
