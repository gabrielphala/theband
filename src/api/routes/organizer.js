...
module.exports = (router) => {
    router.get('/organizer/events', base_controller.render('organizer/events', 'My events'));
    router.get('/organizer/sign-up', base_controller.render('organizer/sign-up', 'Sign up'));
    router.get('/organizer/events/manage', base_controller.render('organizer/manage', 'Manage event'));
