...
/***/ "./public/assets/js/src/auth/Album.js":
/*!********************************************!*\
  !*** ./public/assets/js/src/auth/Album.js ***!
  \********************************************/
  ...
  window.Album = class Album {
    static async addAlbumCover() {
      ...
      if (res.data.successful) {
        $('#album-cover-preview')[0].style.backgroundImage = `url("/assets/uploads/covers/${res.data.cover}")`;
      }
    }
    static async addAlbumName() {
      const res = await (0,_helpers_fetch__WEBPACK_IMPORTED_MODULE_0__["default"])('/album/add-name', {
        body: {
          name: $('#album-name').val()
        }
      });
    ...
    static async getReadyAlbumsByArtist() {
      const res = await (0,_helpers_fetch__WEBPACK_IMPORTED_MODULE_0__["default"])('/albums/get-ready-by-artist');
      $('#no-songs').hide();
      if ((0,_helpers_array__WEBPACK_IMPORTED_MODULE_2__.arrayNotEmpty)(res.albums)) {
        ...
        $('.container__main__center__covers__item__add-song').on('click', e => {
          ...
          (0,_helpers_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('new-song');
        });
        return;
      }
      $('#album-list').html(' ');
...
/***/ "./public/assets/js/src/auth/Artist.js":
/*!*********************************************!*\
  !*** ./public/assets/js/src/auth/Artist.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  window.Artist = class Artist {
    static async signUp() {
      const response = await (0,_helpers_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])('/artist/sign-up', {
        body: {
    ...
    static async signIn() {
      const response = await (0,_helpers_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])('/artist/sign-in', {
        body: {
          email: $('#email-address').val(),
          password: $('#password').val()
        }
...
/***/ "./public/assets/js/src/auth/Event.js":
/*!********************************************!*\
  !*** ./public/assets/js/src/auth/Event.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./public/assets/js/src/auth/Invitation.js":
/*!*************************************************!*\
  !*** ./public/assets/js/src/auth/Invitation.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  window.Invitation = class Invitation {
    ...
    static async viewInvitationOrg(event_id) {
      ...
      if ((0,_helpers_array_js__WEBPACK_IMPORTED_MODULE_0__.arrayNotEmpty)(response.invitations)) {
        ...
        $('#invitation-list').html((0,_helpers_format_js__WEBPACK_IMPORTED_MODULE_2__.formatInvitationsForOrganizer)(response.invitations));
        return;
      }
    ...
    static async decline(invite_id) {
      const response = await (0,_helpers_fetch_js__WEBPACK_IMPORTED_MODULE_1__["default"])('/invitation/decline', {
        body: {
          invite_id
        }
      });
...
/***/ "./public/assets/js/src/auth/Organizer.js":
/*!************************************************!*\
  !*** ./public/assets/js/src/auth/Organizer.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  window.Organizer = class Organizer {
    static async signUp() {
      const response = await (0,_helpers_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])('/organizer/sign-up', {
        body: {
    ...
    static async signIn() {
      const response = await (0,_helpers_fetch_js__WEBPACK_IMPORTED_MODULE_0__["default"])('/organizer/sign-in', {
        body: {
          email: $('#email-address').val(),
          password: $('#password').val()
        }
...
/***/ "./public/assets/js/src/auth/Song.js":
/*!*******************************************!*\
  !*** ./public/assets/js/src/auth/Song.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  window.Song = class Song {
    ...
    static async getReadySongsByArtist() {
      const res = await (0,_helpers_fetch__WEBPACK_IMPORTED_MODULE_0__["default"])('/songs/get-ready-by-artist');
      $('#no-albums').hide();
...
/***/ "./public/assets/js/src/helpers/array.js":
/*!***********************************************!*\
  !*** ./public/assets/js/src/helpers/array.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./public/assets/js/src/helpers/artist-selection.js":
/*!**********************************************************!*\
  !*** ./public/assets/js/src/helpers/artist-selection.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createArtistItem: () => (/* binding */ createArtistItem),
/* harmony export */   removeArtistItem: () => (/* binding */ removeArtistItem)
/* harmony export */ });
const createArtistItem = () => {
...
/***/ "./public/assets/js/src/helpers/error.js":
/*!***********************************************!*\
  !*** ./public/assets/js/src/helpers/error.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const formatAlbumsForArtist = albums => {
  let formated = '';
...
const formatEventsForOrganizer = events => {
  let formated = '';
...
const formatInvitationsForOrganizer = invites => {
  let formated = '';
...
const formatArtistSelect = artists => {
...
/***/ "./public/assets/js/src/helpers/urlquery.js":
/*!**************************************************!*\
  !*** ./public/assets/js/src/helpers/urlquery.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
